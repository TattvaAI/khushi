...
export default function ResumePage() {
  return (
    <>
      {/* ========================================== */}
      {/* WEB VERSION (Hidden during print)          */}
      {/* ========================================== */}
      <div className="w-full min-h-screen bg-background print:hidden">
        <div className="px-6 md:px-12 max-w-4xl mx-auto pt-12 pb-8 flex justify-between items-center animate-fade-in">
          ...
          <div className="flex gap-6">
            <a 
              ...
              download
              className="inline-flex items-center gap-2 text-sm font-sans text-text-muted hover:text-foreground transition-colors duration-300"
            >
            ...
            <button 
              ...
              className="inline-flex items-center gap-2 text-sm font-sans text-foreground hover:text-text-muted transition-colors duration-300"
            >
              <Printer className="w-4 h-4" />
              <span>Print New Version</span>
            </button>
          </div>
        </div>

        <article className="px-6 md:px-12 max-w-4xl mx-auto pb-32 pt-8 animate-slide-up">
          ...
          <section className="mb-8">
            <h2 className="font-sans text-sm uppercase tracking-widest text-foreground font-semibold border-b border-border-strong pb-2 mb-4">Objective</h2>
          ...
          <section className="mb-8">
            <h2 className="font-sans text-sm uppercase tracking-widest text-foreground font-semibold border-b border-border-strong pb-2 mb-6">Professional Experience</h2>
            <div className="mb-6">
              ...
              <div className="flex justify-between items-baseline mb-3">
                <span className="font-sans text-base text-foreground italic font-medium">Equity Research Analyst</span>
              </div>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-baseline mb-3">
                <span className="font-sans text-base text-foreground italic font-medium">General Manager</span>
            ...
            <div className="mb-6">
              ...
              <div className="flex justify-between items-baseline mb-3">
                <span className="font-sans text-base text-foreground italic font-medium">Marketing and Finance Intern</span>
              </div>
              <ul className="list-disc list-outside ml-5 space-y-2 font-serif text-base text-foreground font-light">
          ...
          <section className="mb-8">
            <h2 className="font-sans text-sm uppercase tracking-widest text-foreground font-semibold border-b border-border-strong pb-2 mb-6">Education</h2>
            <div className="flex flex-col md:flex-row justify-between md:items-baseline mb-2">
      ...
      {/* ========================================== */}
      {/* PRINT VERSION (Hidden on web, visible on print) */}
      {/* ========================================== */}
      <div className="hidden print:block w-full bg-white text-black font-serif" style={{ fontSize: '11pt', lineHeight: 1.4 }}>
        
        <header style={{ borderBottom: '2px solid black', paddingBottom: '10px', marginBottom: '15px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '24pt', textTransform: 'uppercase', letterSpacing: '2px', margin: '0 0 5px 0' }}>
            Khushi Bansal
          </h1>
        ...
        <section style={{ marginBottom: '15px' }}>
          <h2 style={{ fontSize: '12pt', textTransform: 'uppercase', borderBottom: '1px solid black', paddingBottom: '4px', margin: '0 0 8px 0', fontFamily: 'sans-serif' }}>
            Objective
          </h2>
          <p style={{ margin: 0 }}>
            Equity Research Analyst offering a rigorous fundamental approach to corporate valuation, financial modeling, and sector-specific thesis generation. Proven ability to construct complex 3-statement models, synthesize quantitative market data, and deliver high-conviction, institutional-grade investment insights.
        ...
        <section style={{ marginBottom: '15px' }}>
          <h2 style={{ fontSize: '12pt', textTransform: 'uppercase', borderBottom: '1px solid black', paddingBottom: '4px', margin: '0 0 10px 0', fontFamily: 'sans-serif' }}>
            Professional Experience
          </h2>
          
          <div style={{ marginBottom: '12px', pageBreakInside: 'avoid' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '2px' }}>
              <h3 style={{ fontSize: '14pt', margin: 0 }}>Walford Capitals</h3>
              <span style={{ fontSize: '10pt', fontStyle: 'italic', fontFamily: 'sans-serif' }}>August 2024 &ndash; Present</span>
            </div>
          ...
          <div style={{ marginBottom: '12px', pageBreakInside: 'avoid' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '6px' }}>
              <div style={{ fontStyle: 'italic', fontWeight: 'bold' }}>General Manager</div>
              <span style={{ fontSize: '10pt', fontStyle: 'italic', fontFamily: 'sans-serif' }}>October 2024 &ndash; June 2025</span>
            </div>
            <ul style={{ margin: '0 0 0 20px', padding: 0 }}>
              <li style={{ marginBottom: '4px' }}>Spearheaded human capital allocation by structuring the recruitment pipeline and onboarding architecture for a 20+ member cross-functional team.</li>
              <li style={{ marginBottom: '4px' }}>Developed institutional-grade investor materials, including executive summaries and pitch decks, successfully deployed to 40+ high-net-worth potential investors.</li>
            </ul>
          </div>

          <div style={{ marginBottom: '12px', pageBreakInside: 'avoid' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '2px' }}>
              <h3 style={{ fontSize: '14pt', margin: 0 }}>Agile Capital Services</h3>
              <span style={{ fontSize: '10pt', fontStyle: 'italic', fontFamily: 'sans-serif' }}>June 2025 &ndash; July 2025</span>
            </div>
            <div style={{ fontStyle: 'italic', fontWeight: 'bold', marginBottom: '6px' }}>Marketing and Finance Intern</div>
            <ul style={{ margin: '0 0 0 20px', padding: 0 }}>
              <li style={{ marginBottom: '4px' }}>Executed fundamental and ratio analysis on leading financial institutions (IFL and SBI Life Insurance) to assess asset quality, capital adequacy, and profitability metrics.</li>
              <li style={{ marginBottom: '4px' }}>Structured and analyzed a quantitative market research survey evaluating the correlation between financial literacy and retail investment behavior.</li>
            </ul>
          </div>
        </section>
        ...
        <section style={{ marginBottom: '15px', pageBreakInside: 'avoid' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '2px' }}>
            <h3 style={{ fontSize: '14pt', margin: 0 }}>Bharati Vidyapeeth (BVIMR), New Delhi</h3>
            <span style={{ fontSize: '10pt', fontStyle: 'italic', fontFamily: 'sans-serif' }}>2023 &ndash; Present</span>
          </div>
          <p style={{ margin: '0 0 4px 0' }}>Bachelor of Business Administration (BBA) &ndash; CGPA: 8.01</p>
          <p style={{ margin: 0 }}><strong style={{ fontFamily: 'sans-serif' }}>Relevant Coursework:</strong> Financial Modeling, Investment Banking, Financial Markets, Technical Analysis, Corporate Finance, Behavioral Finance, Python &amp; Statistics.</p>
        </section>

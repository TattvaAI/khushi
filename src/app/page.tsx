        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            <p className="font-sans text-base text-foreground font-light leading-relaxed">
              Currently an Investment Analyst Intern at Walford Capitals, building comprehensive financial models (DCF, CCA, SOTP) and publishing actionable research notes.
            </p>
            <p className="font-sans text-base text-foreground font-light leading-relaxed">
